...
v0.3.1 - sherpa-onnx Lightweight Engine + Stability Improvements
...
**Stability Improvements (v0.3.1)**
- Fixed overlay window not showing issue
- Fixed audio visualizer display delay
- Improved state management for better stability
...
Core Improvement Summary: v0.3.1 achieves major breakthroughs through complete sherpa-onnx engine replacement: 90% installation size reduction, 30-300x CPU performance boost, complete GPU dependency removal, while adding dual-mode streaming transcription and Qwen ASR support.
